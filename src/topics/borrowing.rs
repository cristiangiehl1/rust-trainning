...
// When borrowing, youre're taking a reference (pointer) to the data, not the data itself.
...
pub fn violate_borrowing_2() {
    let mut s1 = String::from("hello");
    let r1 = &mut s1; // immutable borrow
